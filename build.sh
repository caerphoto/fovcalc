...
sed -e "s/fovcalc.css/$CSS_FILENAME/;s/fovcalc.js/$JS_FILENAME/;s|favicon.png|data:image/png;base64,$FAVICON_B64|;s|http://localhost:9933||" fovcalc.html > build/fovcalc.html &&
